    ...
    public partial class ListClientsManager : Window, IEditManager
    {
        ...
        public void EditClientsList(DataGrid dataGrid)
        {
            ...
            if (dataGrid.SelectedCells.Count != 0)
            {
                ...
                if (EditClientListManagerWindow.Surname_change != 0 || EditClientListManagerWindow.Name_change != 0 
                    || EditClientListManagerWindow.Patronimyc_change != 0 || EditClientListManagerWindow.Number_phone_change != 0 
                    || EditClientListManagerWindow.Passport_change != 0)
                {
                    MessageBox.Show("Ok");
                    ...
                    changedata1[index] = "";
                    if (EditClientListManagerWindow.Surname_change != 0) { changedata1[index] = changedata1[index] + "Фамилия"; }
                    if (EditClientListManagerWindow.Name_change != 0) { changedata1[index] = changedata1[index] + "Имя"; }
                    if (EditClientListManagerWindow.Patronimyc_change != 0) { changedata1[index] = changedata1[index] + "Отчество"; }
                    if (EditClientListManagerWindow.Number_phone_change != 0) { changedata1[index] = changedata1[index] + "Номер телефона"; }
                    if (EditClientListManagerWindow.Passport_change != 0) { changedata1[index] = changedata1[index] + "Паспорт"; }
                    if (EditClientListManagerWindow.Status_change != 0) { changedata1[index] = changedata1[index] + "Статус"; }
